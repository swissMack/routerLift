...
| `docs/BOM.md`, `docs/WIRING-RevH.*`, `docs/PINOUT.svg`, `hardware/system/system.pdf` | Parts and wiring |
| `hardware/` | KiCad schematics (generated) and routed PCBs with JLCPCB fab zips — see hardware/README.md |
